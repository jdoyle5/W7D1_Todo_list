...
var _unique_id = __webpack_require__(174);
...
var TodoForm = function (_React$Component) {
  ...
  _createClass(TodoForm, [{
    ...
    value: function addToDo() {
      ...
      return function () {
        var newTodo = {};
        newTodo['id'] = (0, _unique_id2.default)();
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement('input', { type: 'text', onChange: this.linkState('title'), value: this.state.word }),
        _react2.default.createElement('textarea', { onChange: this.linkState('body'), value: this.state.body }),
        _react2.default.createElement('input', { type: 'submit', onClick: this.addToDo(), value: 'submit' })
      );
    }
  }]);
